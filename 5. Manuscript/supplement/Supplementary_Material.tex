...
\section{\texorpdfstring{\textbf{Code and file
information}}{Code and file information}}\label{code-and-file-information}}

Here is where I will provide a step-by-step document so others will be
able to follow along and easily reproduce my code. I will utilize some
of the text I included in the main text/Manuscript.qmd and will expand
upon it as I work through this project.

\newpage{}

\hypertarget{additional-method-details}{%
\section{\texorpdfstring{\textbf{Additional Method
Details}}{Additional Method Details}}\label{additional-method-details}}

\newpage{}

\hypertarget{additional-results}{%
\section{\texorpdfstring{\textbf{Additional
results}}{Additional results}}\label{additional-results}}
